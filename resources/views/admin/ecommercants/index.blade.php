...
<div class="container-fluid my-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-slate-100 pb-4">
            <div>
                <h3 class="text-xl font-black text-slate-900 tracking-tight">
                    <i class="fas fa-store text-[#0A4BB3] mr-2"></i>Nouveau E-commerçant
                </h3>
                <p class="text-xs font-medium text-slate-400 mt-0.5">Créez un nouveau profil e-commerçant sur la plateforme.</p>
            </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-200/60 shadow-xs overflow-hidden">
        ...
        <div class="p-6 sm:p-8 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Partenaires & Boutiques</span>
                <h2 class="text-2xl font-black text-slate-900 tracking-tight">Liste des E-commerçants</h2>
                <p class="text-slate-400 text-xs mt-0.5 font-medium">Gérez les comptes des e-commerçants inscrits sur la plateforme.</p>
            </div>
            ...
            <button onclick="toggleForm()" class="bg-[#0A4BB3] hover:bg-[#083da3] text-white font-black text-xs uppercase tracking-widest px-5 py-3 rounded-2xl transition shadow-lg shadow-blue-900/10 flex items-center gap-2.5 cursor-pointer border-0">
                <i class="fas fa-plus text-[11px]"></i> Ajouter un E-commerçant
            </button>
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="p-10 text-center text-slate-400 font-bold">
                                <i class="fas fa-store-slash text-2xl block mb-2 text-slate-300"></i> Aucun e-commerçant trouvé dans la base de données.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
