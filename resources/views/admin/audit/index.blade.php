...
<head>
    ...
    <title>MonColis — Audit Log</title>
    ...
    <div class="min-h-screen flex">
        <aside class="w-64 bg-blue-700 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="{{ route('admin.audit.index') }}" class="block px-4 py-2 rounded-lg bg-blue-800">Audit Log</a>
            </nav>
        </aside>
        ...
        <main class="flex-1 p-8">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <p class="text-gray-500 text-center py-4">Historique des actions en cours de développement...</p>
            </div>
        </main>
    </div>
</body>
