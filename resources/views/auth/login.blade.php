...
<body class="bg-[#F8FAFC] antialiased text-slate-800 min-h-screen flex flex-col justify-between">
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 pb-24">
        ...
        <div class="w-full max-w-sm">
            ...
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight mb-1">Connectez-vous</h1>
            <p class="text-slate-400 text-sm mb-6">Accédez à votre espace Shipily.</p>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        <input type="password" name="password" required placeholder=""
                            class="w-full h-12 pl-4 pr-20 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:border-brand-blue shadow-xs transition">
                        <button type="button" class="absolute right-4 text-sm font-bold text-brand-orange hover:underline focus:outline-none">
                            Afficher
                        </button>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between text-sm pt-1">
                    <label class="flex items-center gap-2 cursor-pointer select-none">
                        ...
                        <span class="text-slate-500 font-medium">Se souvenir de moi</span>
                    </label>
                    <a href="#" class="text-brand-blue font-bold text-xs hover:underline">Mot de passe oublié ?</a>
                </div>
            ...
            <div class="mt-8 text-center text-sm">
                <p class="text-slate-400 font-medium">
                    ...
                    <a href="{{ route('register') }}" class="text-brand-orange font-bold hover:underline ml-0.5">Créer un compte</a>
                </p>
            </div>
        </div>
    </main>
